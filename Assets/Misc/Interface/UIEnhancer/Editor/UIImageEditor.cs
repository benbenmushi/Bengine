...
namespace UnityEditor.UI
{
	...
	public class ImageEditor : GraphicEditor
	{
		...
		SerializedProperty m_PreserveAspectSliced;
		SerializedProperty m_slicedSize;
		...
		protected override void OnEnable()
		{
			...
			m_PreserveAspectSliced = serializedObject.FindProperty("m_PreserveAspectSliced");
			m_slicedSize = serializedObject.FindProperty("m_slicedSize");
			...
			++EditorGUI.indentLevel;
			{
				...
				if (EditorGUILayout.BeginFadeGroup(m_ShowSlicedOrTiled.faded))
				{
					if (image.hasBorder)
					{
						...
						EditorGUILayout.PropertyField(m_PreserveAspectSliced);
						EditorGUILayout.PropertyField(m_slicedSize);
					}
				}
				EditorGUILayout.EndFadeGroup();
